...
def main():
    ...
    #   python parser/claude/claude_and_llama.py --file input/sample-3.pdf
    ...
    with open(os.path.join(project_root, "output", "claude_and_llama.txt"), "w", encoding="utf-8") as file:
