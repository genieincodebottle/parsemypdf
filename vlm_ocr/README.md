...
| -------------- | ------------------------------------------------------------ | ------------------ | -------- |---------- |
| Anthropic      | `claude-opus-5`, `claude-sonnet-5`, `claude-sonnet-4-6`, `claude-haiku-4-5`   | Paid               | [Code](/vlm_ocr/anthropic/main.py)              | [Doc](https://www.anthropic.com/claude/sonnet)                                                                                |
| Gemini         | `gemini-pro-latest`, `gemini-flash-latest`, `gemini-flash-lite-latest`, `gemini-2.5-flash` | Paid               | [Code](/vlm_ocr/gemini/main.py)              | [Doc](https://ai.google.dev/gemini-api/docs/models)
| OpenAI         | `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna`, `gpt-4.1`, `gpt-4.1-mini` | Paid               | [Code](/vlm_ocr/openai/main.py)              | [Doc](https://platform.openai.com/docs/models/gpt-4o)
